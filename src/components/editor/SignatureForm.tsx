...
import { PenTool, Calendar, User, FileSignature, Upload, Trash2, CalendarDays } from 'lucide-react';
...
export const SignatureForm: React.FC<SignatureFormProps> = ({
  ...
  const date = signature.date ?? new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' });
          ...
          <div className="space-y-4 pt-1">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                >
                  <CalendarDays className="w-3 h-3" /> Set Today
                </button>
              </div>
              <input
                type="text"
