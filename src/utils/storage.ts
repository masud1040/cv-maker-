...
import { SAMPLE_STUDENT_CV, SAMPLE_GENERAL_CV, SAMPLE_DEVELOPER_CV, SAMPLE_HR_CV, SAMPLE_MODERN_CV, SAMPLE_BIODATA_CV, getBlankCVData } from '../data/templates';
...
export function createNewCV(templateId: CVData['templateId'] = 'ats-student', title?: string): CVData {
  const newCv = getBlankCVData(templateId, title);
